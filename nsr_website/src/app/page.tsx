        ...
        <TokenGate>
          <div className="container mx-auto px-4 py-12">
            ...
            <header className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl mb-6 text-[var(--slate)] dark:text-[var(--cream)] max-w-3xl mx-auto">
                Get access to the latest insights on what is going on in the world of regenerative communities 🌍
              </p>
              <div className="bg-white dark:bg-[var(--charcoal)] p-5 rounded-lg mb-6 max-w-3xl mx-auto">
                <h3 className="text-xl font-semibold mb-2 text-[var(--navy)] dark:text-[var(--gold)]">What is an Alternative Community? 🤔</h3>
                <p className="text-[var(--slate)] dark:text-[var(--cream)]">
                  Alternative communities are intentional groups working outside mainstream systems to create sustainable, equitable ways of living together. They experiment with regenerative agriculture 🌾, community currencies 💰, collaborative governance 🤝, and shared resources to build resilient local ecosystems.
                </p>
              </div>
